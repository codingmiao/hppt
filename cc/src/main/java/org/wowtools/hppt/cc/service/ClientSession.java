...
public class ClientSession {
    ...
    private final ClientSession serverSession = this;

    //真实端口发回来的消息，存在队列里等待回发客户端
    private final BlockingQueue<byte[]> serverSessionSendQueue = new ArrayBlockingQueue<>(StartCc.config.messageQueueSize);
    ...
    public ClientSession(String host, int port, int sessionId) {
        activeSession();
    ...
    private class SimpleClientHandler extends ChannelInboundHandlerAdapter {
        ...
        private final BlockingQueue<byte[]> sendQueue = new ArrayBlockingQueue<>(StartCc.config.messageQueueSize);
        ...
        public void channelActive(ChannelHandlerContext ctx) throws Exception {
            ...
            sendThread = Thread.startVirtualThread(() -> {
                try {
                    ...
                    ClientSessionManager.disposeClientSession(serverSession, "sendThread error");
                }
        ...
        public void channelInactive(ChannelHandlerContext ctx) throws Exception {
            ...
            ClientSessionManager.disposeClientSession(serverSession, "channelInactive");
        }
        ...
        public void channelRead(ChannelHandlerContext ctx, Object msg) {
            ...
            try {
                ...
                ClientSessionManager.disposeClientSession(serverSession, "serverSessionSendQueue 缓冲区已满");
            }
            activeSession();
        ...
        public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
            ...
            ClientSessionManager.disposeClientSession(serverSession, "exceptionCaught");
        }
    ...
    public void putBytes(byte[] bytes) {
        ...
        try {
            ...
            ClientSessionManager.disposeClientSession(serverSession, "simpleClientHandler.sendQueue 已满");
        }
    }
    ...
    public void activeSession() {
        checkOutTime = RoughTimeUtil.getTimestamp() + StartCc.config.sessionTimeout;
        outTime = checkOutTime + StartCc.config.sessionTimeout;
    }
